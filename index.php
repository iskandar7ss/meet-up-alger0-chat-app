...
<body>
  ...
  <div class="wrapper">
    <section class="form signup">
      <header>  <center><img src="Untitled-121212.png" > </center> <center>singup</center></header>
      <form action="#" method="POST" enctype="multipart/form-data" autocomplete="off">
        ...
        <div class="field input">
          ...
          <input type="password" name="password" placeholder="Enter new password" maxlength= 21  required>
